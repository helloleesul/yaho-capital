    ...
    <b-container v-else>
      ...
      <b-row class="align-items-start justify-content-between pt-4">
            ...
            <b-list-group flush>
              ...
              <b-list-group-item>
                ...
                <b-card-text :style="{ height: '19rem' }">
                  <span v-if="!item.content" :style="{ opacity: '.2' }"
                    >상담내용이 없습니다.</span
                  >
        ...
        <b-col>
          ...
          <b-row class="mb-3 align-items-center">
            <b-col class="col-8">
              ...
              >
                ...
                <b-form-radio value="CHECKED" class="checked"
                  >처리완료</b-form-radio
                >
              </b-form-radio-group>
            </b-col>
          ...
          <!-- 작성 -->
          <b-card no-body class="mb-3" v-if="newCommentShow">
            <b-card-body>
              <b-form-textarea
              ...
              <b-row class="align-items-center">
                <b-col class="text-right">
                  <b-btn
                    ...
                    @click="addCommentCheck(newCommentContent)"
                    >저장</b-btn
                  >
                </b-col>
              </b-row>
              ...
              >
                ...
                <b-card-body v-else>
                  <div>
                    ...
                    <b-card-text :style="{ whiteSpace: 'pre-wrap' }">{{
                      list.content
                    }}</b-card-text>
                  </div>
                </b-card-body>
                ...
                <b-card-footer>
                  <b-row class="align-items-center">
                    ...
                    <b-col
                      class="text-right"
                      v-if="$store.state.serviceId == list.user.serviceId"
                    >
                      <div v-if="list.edit">
                        <b-btn
                          size="sm"
                          class="me-2"
                          variant="outline-dark"
                          @click="updateCommentCheck(list.content, list)"
                          >저장</b-btn
                        >
                        <b-btn
                          size="sm"
                          variant="outline-danger"
                          @click="getInquiryDetail()"
                          >취소</b-btn
                        >
                      </div>
                      <div v-else>
