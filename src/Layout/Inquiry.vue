        ...
        >
          ...
          >
            <b-form-select
              ...
              aria-describedby="loan-input-feedback"
              v-model="input.type"
            >
              <template #first>
                <b-form-select-option disabled :value="null"
                  >대출상품을 선택하세요.</b-form-select-option
                >
              </template>
              ...
              >
              <b-form-select-option value="원하는 대출상품 없음"
                >해당없음</b-form-select-option
              >
            </b-form-select>
            <b-form-invalid-feedback id="loan-input-feedback">{{
...
export default {
  ...
  methods: {
    async submit() {
      //   this.input.content = this.input.type + "\n" + this.input.content;
